...
const team = [
    ...
    },
    {
        ...
        experience: "Proven track record of leading massive engineering teams across fintech and cloud-infrastructure domains. Directly responsible for scaling systems to millions of concurrent active connections.",
    ...
    },
    {
        ...
        experience: "Deeply experienced in engineering fluid edge-networks and real-time frontend applications. Pioneer in implementing WebSockets and Server-Sent Events for massive dashboards.",
    ...
    },
    {
        ...
        experience: "Battle-tested in managing massive Kubernetes clusters and globally distributed databases. Has securely automated deployments spanning hundreds of microservices instantly.",
    ...
    },
    {
        ...
        experience: "Seasoned veteran in aggressive expansion strategy across the B2B SaaS sector. Has successfully negotiated multi-million dollar infrastructure contracts with Fortune 500 entities.",
