...
export default function QuotationManager() {
    ...
    const [items, setItems] = useState([
        { id: '1', title: 'Architecture Blueprint & Systems Design', details: 'Comprehensive system architecture map including AWS cloud infrastructure, database schema, and microservice definitions.', rate: 25000, quantity: 1, days: 14 },
        { id: '2', title: 'Full-Stack Development (Estimated Sprints)', details: 'Four bi-weekly sprints focusing on backend deployment, frontend React interface, and real-time socket connections.', rate: 100000, quantity: 1, days: 56 },
    ]);
                ...
                <div className={`p-12 md:p-16 min-h-[600px] flex flex-col ${t.bg}`}>
                    ...
                    <div className="mb-12">
                        ...
                        <div className={`grid grid-cols-12 gap-4 pb-4 border-b-2 text-[10px] font-bold uppercase tracking-widest ${theme === 'light' ? 'border-gray-900 text-gray-500' : 'border-white text-gray-500'}`}>
                            <div className="col-span-12 md:col-span-5">Deliverable Scope & Breakdown</div>
                            ...
                            <div className="col-span-6 md:col-span-2 text-right hidden md:block">Unit Est.</div>
                            <div className="col-span-6 md:col-span-2 text-right hidden md:block">Total Est.</div>
                        </div>
